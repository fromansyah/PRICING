...
class Employee_model extends CI_Model {
    ...
    public function get_emp_flexigrid()
    {
    ...
    {	
        ...
        if($query->result()){
            foreach ($query->result() as $employee) {
                $employees[$employee->emp_id] = $employee->emp_name;
            }
        }
        return $employees;
    }
    
    function getEmployeeListByPosition($position)
    {	
        $this->db->select('emp_id, emp_name');
        ...
        if($query->result()){
            foreach ($query->result() as $employee) {
                $employees[$employee->emp_id] = '['.$employee->emp_id.'] '.$employee->emp_name;
            }
        }
        return $employees;
    }
