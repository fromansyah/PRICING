...
$(document).ready(function(){
  ...
  $('#btn_simpan').click(function(){
   ...
   $.post(
    $_base_url + 'index.php/Role_menu/save_roleMenu_ajax',
    {
...
<fieldset style="position: absolute; top: 65px; left: 240px; width: 300px; height: 200px">
    <legend><?=$role_name?> - Add Menu</legend>
    <input value="<?=$role_id?>" type="hidden" name="role_id" id="role_id" height="4" size="50" class="input_text"/>
    
    <p>
    Menu <br/>
    <?echo form_dropdown('menu_item_id', $menu_list, '', 'id = "menu_item_id" name = "menu_item_id" class="input_text"');?>
    </p>
