...
$(document).ready(function(){
  ...
  $('#btn_generate').click(function(){
    ...
    if ($_type == 'generate') {
        window.location = $_base_url + 'Upload/do_upload_product/'+ fileName;
        //alert(fileName);
    }
  });
  ...
  $('#download_template').click(function(){
    window.location = $_base_url + 'Product/download_template';
  });
});
...
<fieldset style="position: relative; width: 500px; height: 400px;">
    ...
    <br/>
    <p>
    Product CSV File : <input type="file" name="userfile" id="userfile" size="20" class="input_text" accept=".csv"/>
    </p>
    <br/>
    <p>
