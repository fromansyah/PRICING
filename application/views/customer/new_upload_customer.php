...
//                        alert(data);
                        $.post(
                                $_base_url + 'Customer/ajax_upload',
                                {
                                    data: data
                                },
                                function(data) {
    ...
    $('#download_template').click(function(){
        window.location = $_base_url + 'Customer/download_template';
    });

    $('#show_log_file').click(function(){
        window.location = $_base_url + 'Customer/log_file';
    });
});
</script>
    </head>
    <body>
        ...
        <fieldset style="position: relative; width: 500px; height: 400px;">
            ...
            <br/>
            <p>
            Customer CSV File : <input type="file" name="txtFileUpload" id="txtFileUpload" size="20" class="input_text" accept=".csv"/>
            </p>
            <br/>
            <p>
