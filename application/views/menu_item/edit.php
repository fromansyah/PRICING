...
$(document).ready(function(){
  ...
  $('#btn_simpan').click(function(){
    ...
    if ($_type == 'add') {
      ...
      $.post(
        $_base_url + 'index.php/menu_item/update_menuItem_ajax',
        {id: $id.value,
         menu_id: $menu_id.value,
         menu_name: $menu_name.value,
         link: $link.value,
...
<fieldset style="position: absolute; top: 65px; left: 240px; width: 300px; height: 300px">
    ...
    <p>
    Menu Name<br/>
    <input value="<?=$menu_name?>" type="text" name="menu_name" id="menu_name" height="4" size="50" class="input_text"/>
    </p>
    
    <p>
    Link <br/>
    <input value="<?=$link?>" type="text" name="link" id="link" height="4" size="50" class="input_text"/>
    </p>
    
    <p>
    Sequence <br/>
    <input value="<?=$sequence?>" type="text" name="sequence" id="sequence" height="4" size="50" class="input_text"/>
    </p>
