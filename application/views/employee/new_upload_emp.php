...
$(document).ready(function() {
            ...
            alert('The File APIs are not fully supported in this browser!');
                ...
                if(confirm('Are you sure want to upload this file? '+file.name)){
                    ...
                    reader.onload = function(event) {
                        ...
                        $.post(
                                $_base_url + 'index.php/Employee/ajax_upload',
                                {
                                    data: data
                                },
                                function(data) {
    ...
    $('#show_log_file').click(function(){
        window.location = $_base_url + 'index.php/Employee/log_file';
    });
});
</script>
    </head>
    <body>
        ...
        <fieldset style="position: relative; width: 500px; height: 400px;">
            ...
            <br/>
            <p>
            Employee CSV File : <input type="file" name="txtFileUpload" id="txtFileUpload" size="20" class="input_text" accept=".csv"/>
            </p>
            <br/>
            <p>
