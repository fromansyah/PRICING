...
<body>
    <div class="container">
        <span width="100" style="background-color: #e0e0e0; display: block;">
            &nbsp;<font size="5" style="font-weight: bold; color: #737373">Master Data for : <?echo $type_name?></font>
        </span>
        <br/>
        <button class="btn btn-warning" onclick="back_to_mdt()"><i class="glyphicon glyphicon-backward"></i> Back</button>
        <?if($this->session->userdata("role") == 1 || $this->session->userdata("role") == 3):?>
        <button class="btn btn-success" onclick="add_md()"><i class="glyphicon glyphicon-plus"></i> Add Master Data</button>
        <?endif;?>
...
function add_md()
{
    ...
    $('.modal-title').text('Add Periode Detail'); // Set Title to Bootstrap modal title
}
...
//    $('.modal-title').text('Edit Periode Detail'); // Set title to Bootstrap modal title
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Master Data Form</h3>
            </div>
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    <input type="hidden" value="<?=str_replace('slash', '/', $type)?>" name="type"/> 
                    <div class="form-body">
