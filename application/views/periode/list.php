...
<body>
    <div class="container">
        <span width="100" style="background-color: #e0e0e0; display: block;">
            &nbsp;<font size="5" style="font-weight: bold; color: #737373">Period Management</font>
        </span>
        <br/>
        <button class="btn btn-success" onclick="add_periode()"><i class="glyphicon glyphicon-plus"></i> Add Period</button>
...
//    $('[name="periodeId"]').attr("readOnly", false);
...
//            $('[name="periodeNo"]').attr("readOnly", true);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Period Form</h3>
            </div>
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    <div class="form-body">
                        <input type="hidden" value="" name="periodeId"/> 
