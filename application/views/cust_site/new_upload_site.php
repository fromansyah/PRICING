...
//                        alert(data);
                        $.post(
                                $_base_url + 'index.php/Cust_site/ajax_upload',
                                {
                                    data: data
                                },
                                function(data) {
    ...
    $('#download_template').click(function(){
        window.location = $_base_url + 'index.php/Cust_site/download_template';
    });

    $('#show_log_file').click(function(){
        window.location = $_base_url + 'index.php/Cust_site/log_file';
    });
});
</script>
    </head>
    <body>
        ...
        <fieldset style="position: relative; width: 500px; height: 400px;">
            <legend>Upload Customer Site</legend>
            <br/>
            <br/>
            <table>
                <tr>
            ...
            <br/>
            <p>
            Customer Site CSV File : <input type="file" name="txtFileUpload" id="txtFileUpload" size="20" class="input_text" accept=".csv"/>
            </p>
            <br/>
            <p>
