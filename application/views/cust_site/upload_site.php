...
$(document).ready(function(){
  ...
  $('#btn_generate').click(function(){
    ...
    if ($_type == 'generate') {
        window.location = $_base_url + 'index.php/Upload/do_upload_site/'+ fileName;
        //alert(fileName);
    }
  });
...
<fieldset style="position: relative; width: 500px; height: 400px;">
    ...
    <br/>
    <p>
    Customer Site CSV File : <input type="file" name="userfile" id="userfile" size="20" class="input_text" accept=".csv"/>
    </p>
    <br/>
    <p>
