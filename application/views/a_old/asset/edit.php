...
$_base_url = '<?= base_url() ?>';
$num_istallment = <?=$num_installment?>;
...
<fieldset style="position: absolute; top: 80px; left: 20px; width: 480px; height: 650px; padding: 30px;">
    ...
    <p>
    Payment Type <br/>
    <?php echo form_dropdown('payment_type', $payment_type_list, $payment_type, 'id="payment_type" name = "payment_type" class="input_text" disabled="true"'); ?>
    </p>
    ...
    <p>
    <font color="red">*</font> Barcode : <label><?=$asset_barcode?></label><br/>
    
    <input value="<?=$asset_barcode?>" type="text" name="barcode" id="barcode" height="4" size="35" class="input_text" readonly="readonly"/>
    </p>
...
<fieldset style="position: absolute; top: 80px; left: 530px; width: 480px; height: 650px; padding: 30px;">
    ...
    <p>
    Note <br/>
    <textarea rows="3" name="note" id="note" cols="45"><?=$note?></textarea>
