...
function delete_location(id, location) {
  i = confirm('Delete Location : ' + location + ' ?');
  if (i) {
    window.location = _base_url + 'Location/delete/' + id;
  }
}

function edit_location(id) {
  window.location = _base_url + 'Location/edit/' + id;
}

function doCommand(com,grid)
{
    if (com == 'Add') {
      window.location = _base_url + 'Location/add';
    }
    if (com=='Select All')
    {
