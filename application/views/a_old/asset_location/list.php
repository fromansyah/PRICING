...
<body>
    <div class="container">
        <font size="5">Asset Location</font>
        <br/>
        <br/>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('Asset_location/ajax_list/'.$asset_id)?>",
            "type": "POST"
        },
...
function delete_asset_location(id, location)
{
    if(confirm('Are you sure delete this data: ' + location + ' ?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('Asset_location/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
