...
$(document).ready(function(){
  ...
  $('#btn_simpan').click(function(){
    ...
    if ($.trim($phone.value) == '') {
      ...
      $.post(
        $_base_url + 'Vendor/update_vendor_ajax',
        {
         id: $id.value,
         name: $name.value,
         type: $type.value,
...
<fieldset style="position: absolute; top: 65px; left: 240px; width: 300px; height: 330px">
    ...
    <input value="<?=$vendor_id?>" type="hidden" name="id" id="id" height="4" size="50" class="input_text"/>
    
    <p>
    <font color="red">*</font> Vendor Name <br/>
    <input value="<?=$vendor_name?>" type="text" name="name" id="name" height="4" size="50" class="input_text"/>
    </p>
    
    <p>
    <font color="red">*</font> Vendor Type <br/>
    <?echo form_dropdown('vendor_type', $type_list, $vendor_type, 'id = "vendor_type" name = "vendor_type" class="input_text"');?>
    </p>
    
    <p>
    Address <br/>
    <textarea rows="5" name="address" id="address" cols="50"><?=$address?></textarea>
    </p>
    
    <p>
    <font color="red">*</font> Phone <br/>
    <input value="<?=$phone?>" type="text" name="phone" id="phone" height="4" size="50" class="input_text"/>
    </p>
