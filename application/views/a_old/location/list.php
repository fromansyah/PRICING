...
<body>
    <div class="container">
        <font size="5">Location Management</font>
        <br/>
        <br/>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('Location/ajax_list')?>",
            "type": "POST"
        },
...
function edit_location(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Location/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('Location/ajax_add')?>";
    } else {
        url = "<?php echo site_url('Location/ajax_update')?>";
    }
...
function delete_location(id, location)
{
    if(confirm('Are you sure delete this data: ' + location + ' ?'))
    {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="locationId" placeholder="ID" class="form-control" type="text" readonly="true">
