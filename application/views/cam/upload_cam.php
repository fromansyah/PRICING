...
$(document).ready(function(){
  ...
  $('#btn_cancel').click(function(){
    window.location = $_base_url + 'Cam/';
  });
  
  $('#download_template').click(function(){
    window.location = $_base_url + 'Cam/download_template';
  });
});
...
<fieldset style="position: relative; width: 500px; height: 400px;">
    ...
    <br/>
    <p>
    CAM CSV File : <input type="file" name="userfile" id="userfile" size="20" class="input_text" accept=".csv"/>
    </p>
    <br/>
    <p>
