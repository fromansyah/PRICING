            ...
            alert('The File APIs are not fully supported in this browser!');
                ...
                if(confirm('Are you sure want to upload this file? '+file.name)){
                    ...
                    reader.onload = function(event) {
                        ...
                        $.post(
                                $_base_url + 'index.php/Agreement/ajax_upload',
                                {
                                    data: data
                                },
                                function(data) {
...
//                        alert('test');  
    ...
    $('#btn_cancel').click(function(){
        window.location = $_base_url + 'index.php/Agreement/';
    });

    $('#download_template').click(function(){
        window.location = $_base_url + 'index.php/Agreement/download_template';
    });

    $('#show_log_file').click(function(){
        window.location = $_base_url + 'index.php/Agreement/log_file';
    });
});
</script>
    </head>
    <body>
        ...
        <fieldset style="position: relative; width: 500px; height: 400px;">
            ...
            <br/>
            <p>
            Agreement CSV File : <input type="file" name="txtFileUpload" id="txtFileUpload" size="20" class="input_text" accept=".csv"/>
            </p>
            <br/>
            <p>
