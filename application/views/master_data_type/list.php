...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('index.php/Master_data_type/ajax_list')?>",
            "type": "POST"
        },
...
function view_md(id){
    window.location = _base_url + 'index.php/Master_data/lists/' + id.replace('/', 'slash');
}
...
//    $('.modal-title').text('Edit Master Data Type'); // Set Title to Bootstrap modal title
    ...
    $.ajax({
        url : "<?php echo site_url('index.php/Master_data_type/ajax_edit/')?>/" + id.replace('/', 'slash'),
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('index.php/Master_data_type/ajax_add')?>";
    } else {
        url = "<?php echo site_url('index.php/Master_data_type/ajax_update')?>";
    }
...
function delete_mdt(id, periode)
{
    if(confirm('Are you sure delete this periode: ' + periode + ' ?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('index.php/Master_data_type/ajax_delete')?>/"+ id.replace('/', 'slash'),
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="typeName" placeholder="Type Name" class="form-control" type="text" readonly="true">
                                <span class="help-block"></span>
                            </div>
                        </div>
                    </div>
