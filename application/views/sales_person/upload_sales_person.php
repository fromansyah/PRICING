...
$(document).ready(function(){
  ...
  $('#btn_generate').click(function(){
    ...
    if ($_type == 'generate') {
        window.location = $_base_url + 'Upload/do_upload_sales_person/'+ fileName;
        //alert(fileName);
    }
  });
  
  $('#btn_cancel').click(function(){
    window.location = $_base_url + 'Sales_person/';
  });
  
  $('#download_template').click(function(){
    window.location = $_base_url + 'Sales_person/download_template';
  });
});
...
<fieldset style="position: relative; width: 500px; height: 400px;">
    <legend>Upload Sales Person</legend>
    <br/>
    <br/>
    ...
    <br/>
    <p>
    Sales Person CSV File : <input type="file" name="userfile" id="userfile" size="20" class="input_text" accept=".csv"/>
    </p>
    <br/>
    <p>
