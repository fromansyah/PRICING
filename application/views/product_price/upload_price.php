...
$(document).ready(function(){
  ...
  $('#btn_generate').click(function(){
    ...
    if ($_type == 'generate') {
        window.location = $_base_url + 'Upload/do_upload_price/'+ fileName;
        //alert(fileName);
    }
  });
...
<fieldset style="position: relative; width: 500px; height: 400px;">
    <legend>Upload Product Price</legend>
    <br/>
    <br/>
    ...
    <br/>
    <p>
    Product Price CSV File : <input type="file" name="userfile" id="userfile" size="20" class="input_text" accept=".csv"/>
    </p>
    <br/>
    <p>
