...
jQuery.jGlideMenu = {
	...
	initialize : function(o)
	{
		// Return jQuery
			...
			// Ensure Values (Basic)
			if(s.closeLinkMarkUp.length<1) s.closeLinkMarkUp = '';	
	...
	loadTile : function(u,p)
	{
		...
		if(jQuery.jGlideMenu.tileCount > 1)
		{
			...
			{
				// Insert Reset Button
				jQuery('#'+ptr.id).append('<div class="jGM_reset"><a href="#">&laquo; Main</a></div>');
	...
	buildTile : function(t,d,l)
	{
		...
		// Scroll Up
		template += '<div class="jGM_pager"><a href="#" rel="Up" title="Scroll Up" style="display:none"><img src="http://localhost/HR_APP/images/arrow_up2.gif" alt="Scroll Up"/></a></div>';
...
//				+jQuery.jGlideMenu.imagePath+'arrow_dn.gif" alt="Scroll Up"/></a></div>';
                template += '<div class="jGM_pager"><a href="#" rel="Down" title="Scroll Down" style="display:none"><img src="http://localhost/HR_APP/images/arrow_dn2.gif" alt="Scroll Up"/></a></div>';
		return template;	
	},
